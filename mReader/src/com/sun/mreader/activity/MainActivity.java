...
import com.sun.mreader.adapter.BookShelfAdapter;
import com.sun.mreader.adapter.BookShelfAdapter.OnOpenMenuListener;
...
import com.sun.mreader.ui.BookGridView;
...
public class MainActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBookGridView = (BookGridView) findViewById(R.id.gridview);
		...
		mBookGridView.setAdapter(mBookShelfAdapter);

...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.sun.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.sun.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.sun.swipebacklayout.lib.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
...
//            	if(true)            	return true;
     ...
     * {@link com.sun.swipebacklayout.lib.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     * 
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
